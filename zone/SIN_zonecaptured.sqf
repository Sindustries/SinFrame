...
systemChat format["%1",SINenemy_controlledzones];
...
_supplies = floor (random _income);
[_supplies] call SIN_fnc_addMoney;
...
str(_markername2) setMarkerColor SINsidecolour;
...
HQofficer sideChat format["The %1 has been captured. Don't let it fall into enemy hands!",_name];
HQofficer sideChat format["We sold enemy resources for $%1",_supplies];
